					...
					<div class="banner-top1">
						<div class="banner-info_agile_w3ls">
							<div class="container">
								...
								<p class="mt-3 mb-md-5 mb-3">Medicare Hospitals has been setting standards since its inception in 2005 regarded as best hospital in Punjab Ludhiana India.
								</p></p>
					...
					<div class="banner-top2">
						<div class="banner-info_agile_w3ls">
							<div class="container">
								...
								<p class="mt-3 mb-md-5 mb-3">Our team of over 1000 doctors join me in giving you the best of modern healthcare to ensure you stay healthy, always</p>
									<i class="fa fa-caret-right ml-2" aria-hidden="true"></i>
								</a>
							</div>
						</div>
		...
		<div class="container py-xl-5 py-lg-3">
			<div class="row">
				<div class="col-lg-5 welcome-right">
					<img src="../../../media/hospital/b2.png" alt=" " class="img-fluid">
				</div>
				<div class="col-lg-7 welcome-left mt-4">
					<h3>Your Care, Our Commitment</h3>
		...
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="row package-grids mt-5">
				<div class="col-md-4 pricing">
					<div class="price-top">
						<a href="{% url 'hospital:single' %}">
							<img src="../../../media/hospital/blog1.jpg" alt="" class="img-fluid" />
						</a>
						<h3>13
							<span>August</span>
						</h3>
				...
				<div class="col-md-4 pricing my-md-0 my-5">
					<div class="price-top">
						<a href="{% url 'hospital:single' %}">
							<img src="../../../media/hospital/blog2.jpg" alt="" class="img-fluid" />
						</a>
						<h3>24
							<span>August</span>
						</h3>
				...
				<div class="col-md-4 pricing">
					<div class="price-top">
						<a href="{% url 'hospital:single' %}">
							<img src="../../../media/hospital/blog3.jpg" alt="" class="img-fluid" />
						</a>
						<h3>30
							<span>August</span>
						</h3>
		...
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="row">
				<div class="col-lg-6 w3ls-wthree-screen text-center">
					<img src="../../../media/hospital/b5.png" alt="" class="img-fluid">
				</div>
